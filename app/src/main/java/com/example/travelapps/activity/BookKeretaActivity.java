...
public class BookKeretaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String[] asal = {"pekanbaru", "padang", "medan", "malang", "jakarta"};
        final String[] tujuan = {"jakarta", "padang", "medan", "malang", "jakarta"};
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (sAsal != null && sTujuan != null && sTanggal != null && sDewasa != null) {
                    if ((sAsal.equalsIgnoreCase("pekanbaru") && sTujuan.equalsIgnoreCase("pekanbaru"))
                            || (sAsal.equalsIgnoreCase("padang") && sTujuan.equalsIgnoreCase("padang"))
    ...
    public void perhitunganHarga() {
        if (sAsal.equalsIgnoreCase("pekanbaru") && sTujuan.equalsIgnoreCase("padang")) {
            hargaDewasa = 130000;
            hargaAnak = 80000;
        } else if (sAsal.equalsIgnoreCase("pekanbaru") && sTujuan.equalsIgnoreCase("medan")) {
            hargaDewasa = 200000;
            hargaAnak = 150000;
        } else if (sAsal.equalsIgnoreCase("pekanbaru") && sTujuan.equalsIgnoreCase("malang")) {
            hargaDewasa = 350000;
            hargaAnak = 220000;
        } else if (sAsal.equalsIgnoreCase("pekanbaru") && sTujuan.equalsIgnoreCase("jakarta")) {
            hargaDewasa = 480000;
            hargaAnak = 340000;
        } else if (sAsal.equalsIgnoreCase("padang") && sTujuan.equalsIgnoreCase("pekanbaru")) {
            hargaDewasa = 130000;
            hargaAnak = 80000;
        } else if (sAsal.equalsIgnoreCase("padang") && sTujuan.equalsIgnoreCase("medan")) {
            hargaDewasa = 150000;
            hargaAnak = 100000;
        } else if (sAsal.equalsIgnoreCase("padang") && sTujuan.equalsIgnoreCase("malang")) {
            hargaDewasa = 320000;
            hargaAnak = 190000;
        } else if (sAsal.equalsIgnoreCase("padang") && sTujuan.equalsIgnoreCase("jakarta")) {
            hargaDewasa = 390000;
            hargaAnak = 260000;
        } else if (sAsal.equalsIgnoreCase("medan") && sTujuan.equalsIgnoreCase("pekanbaru")) {
            hargaDewasa = 280000;
            hargaAnak = 250000;
        } else if (sAsal.equalsIgnoreCase("medan") && sTujuan.equalsIgnoreCase("padang")) {
            hargaDewasa = 150000;
            hargaAnak = 100000;
        } else if (sAsal.equalsIgnoreCase("medan") && sTujuan.equalsIgnoreCase("malang")) {
            hargaDewasa = 470000;
            hargaAnak = 330000;
        } else if (sAsal.equalsIgnoreCase("medan") && sTujuan.equalsIgnoreCase("jakarta")) {
            hargaDewasa = 480000;
            hargaAnak = 250000;
        } else if (sAsal.equalsIgnoreCase("malang") && sTujuan.equalsIgnoreCase("pekanbaru")) {
            hargaDewasa = 450000;
            hargaAnak = 250000;
        } else if (sAsal.equalsIgnoreCase("malang") && sTujuan.equalsIgnoreCase("padang")) {
            hargaDewasa = 320000;
            hargaAnak = 190000;
        } else if (sAsal.equalsIgnoreCase("malang") && sTujuan.equalsIgnoreCase("medan")) {
            hargaDewasa = 380000;
            hargaAnak = 140000;
        } else if (sAsal.equalsIgnoreCase("malang") && sTujuan.equalsIgnoreCase("jakarta")) {
            hargaDewasa = 180000;
            hargaAnak = 130000;
        } else if (sAsal.equalsIgnoreCase("jakarta") && sTujuan.equalsIgnoreCase("pekanbaru")) {
            hargaDewasa = 380000;
            hargaAnak = 240000;
        } else if (sAsal.equalsIgnoreCase("jakarta") && sTujuan.equalsIgnoreCase("padang")) {
            hargaDewasa = 290000;
            hargaAnak = 200000;
        } else if (sAsal.equalsIgnoreCase("jakarta") && sTujuan.equalsIgnoreCase("medan")) {
            hargaDewasa = 480000;
            hargaAnak = 40000;
